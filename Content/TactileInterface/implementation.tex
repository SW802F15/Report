...
\Ivan{Skriv hvorfor vi bruger taps i stedet for gestures.}
manner as described in \Cref{subsec:handleTaps}. Two classes are involved the in implementation of the NGUI: 
\begin{itemize}
...
\Ivan{Lav tabel, der viser funktioner i forhold til taps.}{}
