...
The following are some of the most interesting user stories used to develop the Music Player module. Some of the stories depend on other modules: it is, for example, not possible to ``Play .mp3 files'' without the Song Scanner, which is described in \Cref{chap:songScanner}.
...
\end{itemize}}
\Dan{``Adjust music speed'' should either have a higher priority or there should be one specifically for finding appropriate songs.}
