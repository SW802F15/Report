...
\end{itemize}
\Ivan{Not sure it is a good idea to cut practices. Its free to use them all.}
\Ivan{We are so close to using all of XP, why not go all the way.}
...
\Ivan{Acceptance test not a part of coding process.}
...
\Ivan{Not an argument!}
\Ivan{Our goals written in problem statement is very close to a metaphor.}
