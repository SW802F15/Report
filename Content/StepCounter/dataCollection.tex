...
To generate the sample data we had a person perform the following tasks while carrying the smartphone in a specific position (in hand, in pocket or strapped to arm). \Alexander{Purpose is now strictly arm, shouldn't we change it here then?}
\begin{enumerate}
