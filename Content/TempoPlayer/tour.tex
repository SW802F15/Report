...
When the user stands still and the SPM is 0, all songs in the library will be available in a shuffled order.\Ivan{"When the user stands still and the SPM is 0..." skal lige forklares lidt bedre. Eksakt 0 eller? Hvordan definerer vi vores stand ``still window?''}
