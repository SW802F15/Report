...
This lead to pair programming being more difficult to execute, and we decided to get a proper monitor for each pair, to provide the best possible work environment for the practice.\Christoffer{was the old text better? (look in comments)} %make sure the work environment would not have a negative impact on the practice. 
